package
{
	...
	public class SubAboutPresskit extends MovieClip
	{
		...
		public function SubAboutPresskit(pdatabase:Database) 
		{
			...
			subplaintext = new SubPlainText(database.data.presskit);
