package
{
	...
	public class SubAboutAdmissions extends MovieClip
	{
		...
		public function SubAboutAdmissions(pdatabase:Database) 
		{
			...
			subplaintext = new SubPlainText(database.data.admissions);
